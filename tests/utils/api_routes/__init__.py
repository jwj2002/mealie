...
households_search_sites = "/api/households/search-sites"
"""`/api/households/search-sites`"""
households_search_sites_restore_defaults = "/api/households/search-sites/restore-defaults"
"""`/api/households/search-sites/restore-defaults`"""
...
recipes_create_bulk_text_stream = "/api/recipes/create/bulk-text/stream"
"""`/api/recipes/create/bulk-text/stream`"""
recipes_create_zip = "/api/recipes/create/zip"
"""`/api/recipes/create/zip`"""
recipes_exports = "/api/recipes/exports"
"""`/api/recipes/exports`"""
recipes_hunt_search = "/api/recipes/hunt/search"
"""`/api/recipes/hunt/search`"""
